...
lvgl/examples/libs/sjpg/%.o lvgl/examples/libs/sjpg/%.su: ../lvgl/examples/libs/sjpg/%.c lvgl/examples/libs/sjpg/subdir.mk
...
clean-lvgl-2f-examples-2f-libs-2f-sjpg:
	-$(RM) ./lvgl/examples/libs/sjpg/lv_example_sjpg_1.d ./lvgl/examples/libs/sjpg/lv_example_sjpg_1.o ./lvgl/examples/libs/sjpg/lv_example_sjpg_1.su
