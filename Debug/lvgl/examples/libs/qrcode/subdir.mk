...
lvgl/examples/libs/qrcode/%.o lvgl/examples/libs/qrcode/%.su: ../lvgl/examples/libs/qrcode/%.c lvgl/examples/libs/qrcode/subdir.mk
...
clean-lvgl-2f-examples-2f-libs-2f-qrcode:
	-$(RM) ./lvgl/examples/libs/qrcode/lv_example_qrcode_1.d ./lvgl/examples/libs/qrcode/lv_example_qrcode_1.o ./lvgl/examples/libs/qrcode/lv_example_qrcode_1.su
